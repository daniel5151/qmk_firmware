...
fn main() {
    ...
    let qmk_base = PathBuf::from(env::var("PWD").expect("did not specify PWD env var"));
    ...
    let clang_flags =
        std::fs::read_to_string(qmk_base.join(keymap_output).join("preprocessor.txt"))
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg(format!("-working-directory={}", qmk_base.to_str().unwrap()))
