...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, TG_NKRO, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,          _______, KC_VOLD, \
    _______, _______, _______,                            KC_MPLY,                              MO(2), _______, _______, _______, _______  \
  ),
  [2] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, LED_SNK, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
